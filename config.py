...
def get_parser():
    ...
    parser.add_argument("--layer_sched_config", type=str, default="none", help="Per-layer scheduler configuration string")
    parser.add_argument("--hessian_cap_type", type=str, default="none", choices=["none", "hard", "soft"], help="Type of Hessian capping")
    parser.add_argument("--hessian_cap_val", type=float, default=2.0, help="Threshold for hard cap (stability limit) or Coefficient for soft cap")
    parser.add_argument("--freeze_layer", type=str, default=None, help="Name of the layer to freeze (e.g., 'fc1', 'layer1')")
