...
COMMANDS=(
    ...
    "python3 implicit_regularization.py --seed=2025 --activation=relu --runs=20 --name=3snormal_m=0std=3 --normal_std=3 --initialization=normal --exp_name=omega --epochs=200 --lr=1e-3 --dataset=MNIST "

    # "python3 implicit_regularization.py --seed=2025 --activation=relu --runs=4 --name=3snormal_m=0std=1_base --normal_std=1 --initialization=normal --exp_name=scratch_v --epochs=200 --lr=1e-3 --dataset=MNIST  --reset_model"
    "python3 implicit_regularization.py --seed=2025 --activation=relu --runs=20 --name=3snormal_m=0std=1 --normal_std=1 --initialization=normal --exp_name=omega --epochs=200 --lr=1e-3 --dataset=MNIST "
    ...
    "python3 implicit_regularization.py --seed=2025 --activation=relu --runs=20 --name=3uniform_m=0std=5 --uniform_b=5 --initialization=uniform --exp_name=omega --epochs=200 --lr=1e-3 --dataset=MNIST "
