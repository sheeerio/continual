 ...
 #   "python3 implicit_regularization.py --seed=2025 --activation=relu --runs=3 --name=3uniform_0.01 --uniform_a=-0.01 --uniform_b=0.01 --initialization=uniform --exp_name=scratch_v --epochs=250 --dataset=MNIST --reset_optimizer"
  ...
  #  "python3 implicit_regularization.py --seed=2025 --activation=relu --runs=3 --name=3uniform_10+-0.01 --uniform_a=9.99 --uniform_b=10.01 --initialization=uniform --exp_name=scratch_v --epochs=250 --dataset=MNIST --reset_optimizer"
   ...
   # "python3 implicit_regularization.py --seed=2025 --activation=relu --runs=3 --name=3uniform_xavier_base --initialization=xavier --exp_name=scratch_v --epochs=250 --dataset=MNIST --reset_optimizer --reset_model"
    ...
    # "python3 implicit_regularization.py --seed=2025 --model=MLP --activation=relu --runs=3 --reg=l2 --l2_lambda=1e-4 --name=3l2 --exp_name=tai --epochs=700 --lr=1e-3 --dataset=MNIST --reset_optimizer"
    # "python3 implicit_regularization.py --seed=2025 --model=MLP --activation=relu --runs=3 --reg=wass --wass_lambda=3e-2 --name=3wass_baseline_250 --exp_name=tai --epochs=250 --lr=1e-3 --dataset=MNIST --reset_model --reset_optimizer"
    ...
    # "python3 implicit_regularization.py --seed=2025 --activation=relu --runs=5 --name=mlp --exp_name=tai --epochs=100 --lr=1e-3 --dataset=MNIST --reset_optimizer"
    # "python3 implicit_regularization.py --seed=2025 --activation=relu --runs=5 --name=ala --exp_name=tai --epochs=500 --lr=1e-3 --dataset=MNIST --reset_optimizer --lr_schedule=wsd"
    ...
    # "python3 implicit_regularization.py --seed=2027 --activation=relu --runs=5 --name=M_relu_reset --exp_name=tai --epochs=500 --lr=1e-3 --dataset=MNIST --reset_optimizer --reset_model"
    # "python3 implicit_regularization.py --seed=2027 --activation=relu --runs=5 --name=M_relu --exp_name=tai --epochs=500 --lr=1e-3 --dataset=MNIST --reset_optimizer"
    # "python3 implicit_regularization.py --seed=2026 --reg=l2 --l2_lambda=1e-4 --activation=relu --runs=20 --name=l2 --exp_name=tai --epochs=300 --lr=1e-3 --dataset=MNIST --reset_optimizer" 
    # "python3 implicit_regularization.py --seed=2026 --reg=l2 --l2_lambda=1e-4 --activation=relu --runs=20 --name=l2_r --exp_name=tai --epochs=300 --lr=1e-3 --dataset=MNIST --reset_optimizer --reset_model" 
    # "python3 implicit_regularization.py --model=BatchNormMLP --seed=2026 --activation=relu --runs=20 --name=batchnorm --exp_name=tai --epochs=300 --lr=1e-3 --dataset=MNIST --reset_optimizer"  
    # "python3 implicit_regularization.py --model=BatchNormMLP --seed=2026 --activation=relu --runs=20 --name=batchnorm_r --exp_name=tai --epochs=300 --lr=1e-3 --dataset=MNIST --reset_optimizer --reset_model"
    "python3 implicit_regularization.py --seed=2025 --runs=20 --epochs=300 --model=BatchNormMLP --activation=relu --reg=l2 --l2_lambda=1e-4 --name=bn+l2 --exp_name=new"
    "python3 implicit_regularization.py --seed=2026 --runs=20 --epochs=300 --model=BatchNormMLP --activation=relu --reg=l2 --l2_lambda=1e-4 --name=bn+l2 --exp_name=new"
    "python3 implicit_regularization.py --seed=2027 --runs=20 --epochs=300 --model=BatchNormMLP --activation=relu --reg=l2 --l2_lambda=1e-4 --name=bn+l2 --exp_name=new"
    # "python3 implicit_regularization.py --seed=2026 --activation=crelu --runs=20 --name=crelu --exp_name=tai --epochs=300 --lr=1e-3 --dataset=MNIST --reset_optimizer" 
    # "python3 implicit_regularization.py --seed=2026 --activation=crelu --runs=20 --name=crelu_r --exp_name=tai --epochs=300 --lr=1e-3 --dataset=MNIST --reset_optimizer --reset_model" 
    # "python3 implicit_regularization.py --seed=2025 --activation=crelu --runs=20 --name=crelu --exp_name=tai --epochs=300 --lr=1e-3 --dataset=MNIST --reset_optimizer" 
    # "python3 implicit_regularization.py --seed=2025 --activation=crelu --runs=100 --name=crelu --exp_name=tai --epochs=300 --lr=1e-3 --dataset=MNIST"
    # "python3 implicit_regularization.py --seed=2027 --activation=crelu --runs=20 --name=crelu_no_reset_opt --exp_name=tai --epochs=300 --lr=1e-3 --dataset=MNIST" 
    # "python3 implicit_regularization.py --seed=2027 --activation=crelu --runs=20 --name=crelu_r --exp_name=tai --epochs=300 --lr=1e-3 --dataset=MNIST --reset_optimizer --reset_model" 


    # "python3 implicit_regularization.py --seed=2027 --activation=relu --runs=20 --name=mlp --exp_name=tai --epochs=300 --lr=1e-3 --dataset=MNIST --reset_optimizer"
    # "python3 implicit_regularization.py --seed=2027 --activation=relu --runs=20 --name=mlp_r --exp_name=tai --epochs=300 --lr=1e-3 --dataset=MNIST --reset_optimizer --reset_model"
    # "python3 implicit_regularization.py --model=CNN --seed=2027 --activation=relu --runs=20 --name=cnn --exp_name=tai --epochs=300 --lr=1e-3 --dataset=MNIST --reset_optimizer"
    # "python3 implicit_regularization.py --model=CNN --seed=2027 --activation=relu --runs=20 --name=cnn_r --exp_name=tai --epochs=300 --lr=1e-3 --dataset=MNIST --reset_optimizer --reset_model"
    # "python3 implicit_regularization.py --seed=2027 --reg=l2 --l2_lambda=1e-4 --activation=relu --runs=20 --name=l2 --exp_name=tai --epochs=300 --lr=1e-3 --dataset=MNIST --reset_optimizer" 
    # "python3 implicit_regularization.py --seed=2027 --reg=l2 --l2_lambda=1e-4 --activation=relu --runs=20 --name=l2_r --exp_name=tai --epochs=300 --lr=1e-3 --dataset=MNIST --reset_optimizer --reset_model" 
    # "python3 implicit_regularization.py --model=BatchNormMLP --seed=2027 --activation=relu --runs=20 --name=batchnorm --exp_name=tai --epochs=300 --lr=1e-3 --dataset=MNIST --reset_optimizer"  
    # "python3 implicit_regularization.py --model=BatchNormMLP --seed=2027 --activation=relu --runs=20 --name=batchnorm_r --exp_name=tai --epochs=300 --lr=1e-3 --dataset=MNIST --reset_optimizer --reset_model"
